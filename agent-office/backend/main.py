"""
main.py — FastAPI app principal: lifespan, ficheiros estáticos, rotas API,
WebSocket endpoint.
"""
...
# Lista de fallback usada quando .claude/agents/ não existe ou está vazia.
_FALLBACK_AGENTS = [
    "architect",
    "backend_dev",
    "challenger",
...
# Mount em /static para não colidir com a rota "/" e as rotas /api/*.
# O frontend deve referenciar recursos como /static/style.css, /static/app.js.
