...
// --- Coordinator — cabelo prateado, fato escuro, gravata dourada ---
const [CHAR_COORDINATOR_0, CHAR_COORDINATOR_1] = (() => {
  const P = { _: null, H: '#8888a8', K: '#f4c5a1', B: '#c0a080', W: '#ffffff', E: '#1e2a50', F: '#141c38', G: '#d4a820', L: '#202838', S: '#303848' };
  const head = [
    "___HHHHHHHH_____",
    "__HHHHHHHHHH____",
    "__HHKKKKKKKH____",
