...
function sendUserMessage() {
  ...
  // Destaca o coordinator imediatamente no canvas enquanto aguarda resposta
  handleActiveAgent(COORDINATOR);
...
async function init() {
  ...
  // Mensagem de arranque com sugestões genéricas
  chat.showWelcomeMessage((text) => {
    if (isWaiting) return;
